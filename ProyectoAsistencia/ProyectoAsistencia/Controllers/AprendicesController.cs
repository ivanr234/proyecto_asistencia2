...
namespace ProyectoAsistencia.Controllers
{
    public class AprendicesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "aprendiz_id,nombre,apellido,imagen,correo_electronico,contraseña,numero_documento,tipo_documento,numero_aprendiz,direccion,estado")] Aprendices aprendices)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "aprendiz_id,nombre,apellido,imagen,correo_electronico,contraseña,numero_documento,tipo_documento,numero_aprendiz,direccion,estado")] Aprendices aprendices)
        {
            if (ModelState.IsValid)
            {
