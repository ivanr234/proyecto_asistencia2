...
namespace WebApplication4.Controllers
{
    public class ProgramasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "programa_id,nombre_programa,descripcion,duracion_programa,tipo_programa")] Programas programas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "programa_id,nombre_programa,descripcion,duracion_programa,tipo_programa")] Programas programas)
        {
            if (ModelState.IsValid)
            {
